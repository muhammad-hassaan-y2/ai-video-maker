      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/chat">
              <Button className="bg-gradient-to-r from-pink-500 to-violet-500 hover:from-pink-600 hover:to-violet-600 text-lg py-6 px-8 shadow-lg shadow-purple-700/30 transition-all duration-300 hover:scale-105">
        ...
        <motion.div
          ...
          ref={videoRef}
        >
          <div className="relative w-full aspect-video rounded-xl overflow-hidden border-2 border-purple-400/50 shadow-[0_0_40px_rgba(168,85,247,0.5)] backdrop-blur-sm">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-violet-500/10 z-10"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center shadow-lg shadow-purple-700/30 hover:scale-110 transition-transform duration-300 cursor-pointer">
