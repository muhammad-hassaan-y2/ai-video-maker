    ...
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            How It{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Works</span>
          </motion.h2>
          <motion.p
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-between">
          {steps.map((step, index) => (
            ...
            >
              <div className="w-24 h-24 rounded-full bg-gray-500 backdrop-blur-sm flex items-center justify-center mb-6 border border-white/20 shadow-lg shadow-yellow-700/20 hover:scale-110 transition-transform duration-300">
                <div className="text-yellow-400">{step.icon}</div>
              </div>
              <div className="relative mb-8 md:mb-0 md:h-1 md:w-full">
                
                <div className="md:hidden absolute left-1/2 transform -translate-x-1/2 top-0 w-1 h-8 bg-gradient-to-b from-yellow-400 to-blue-500"></div>
              </div>
